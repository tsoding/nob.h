...
int main(int argc, char **argv)
{
    ...
    Nob_Cmd cmd = {0};
    // Cache data will be read and witten to a .file_path field ("build/nob.cache" in this case.)
    // In case .file_path filed is not set, cache data will only be in memory.
